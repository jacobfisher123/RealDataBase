...
def Grade_9_Teacher_list_details(request, pk):
	...
	sum_std_clsA=Grade_9_Student.objects.filter(is_Grade_9_student_classA=True).count()
	sum_std_clsB=Grade_9_Student.objects.filter(is_Grade_9_student_classB=True).count()
	sum_std_clsC=Grade_9_Student.objects.filter(is_Grade_9_student_classC=True).count()
