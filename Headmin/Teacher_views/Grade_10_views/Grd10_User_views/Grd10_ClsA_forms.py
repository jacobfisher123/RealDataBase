...
from Teacher.Teacher_views.Grade10_views.Grd10_teacher_models import Grade_10_Teacher_Class
...
class TeacherGrd9_Class_SignUp_Form(UserCreationForm):
	...
	class_choices=(
	('Select', "Select class"),
	('is_Grade_10_teacher_classA', "Class A"),
    ('is_Grade_10_teacher_classB', "Class B"),
    ("is_Grade_10_teacher_classC", "Class C"),
    ("is_Grade_10_teacher_classD", "Class D"),
    ("is_Grade_10_teacher_classE", "Class E"),
    ("is_Grade_10_teacher_classF", "Class F"),
    ("is_Grade_10_teacher_classG", "Class G"),
    ("is_Grade_10_teacher_classH", "Class H"),
    ("is_Grade_10_teacher_classI", "Class I"),
    ("is_Grade_10_teacher_classJ", "Class J"),
)
