...
class Question(models.Model):
    post_owner = models.ForeignKey(Account, on_delete=models.CASCADE)
    title = models.CharField(max_length=5000, default='')
    body = MartorField()
    tags = TaggableManager()
    date = models.DateTimeField(auto_now_add=True)
    active_date = models.DateTimeField(auto_now=True)
    viewers = models.ManyToManyField(Account, related_name='viewed_posts', blank=True)
    q_reputation = models.IntegerField(default=0)
    q_edited_by = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='q_edited_by', default='', null=True, blank=True)
    ...
    lastActiveFor_by = models.ForeignKey(Account, on_delete=models.CASCADE,related_name='lastActiveFor_by', blank=True, null=True)
...
class BookmarkQuestion(models.Model):
    bookmarked_by = models.ForeignKey(Account, on_delete=models.CASCADE)
...
class QUpvote(models.Model):
    upvote_by_q = models.ForeignKey(Account, on_delete=models.CASCADE)
...
class QDownvote(models.Model):
    downvote_by_q = models.ForeignKey(Account, on_delete=models.CASCADE)
...
class Answer(models.Model):
    answer_owner = models.ForeignKey(Account, on_delete=models.CASCADE)
    questionans = models.ForeignKey(Question, on_delete=models.CASCADE)
    date = models.DateTimeField(auto_now_add=True)
    body = MartorField()
    a_vote_ups = models.ManyToManyField(Account, related_name='a_vote_up', blank=True)
    a_vote_downs = models.ManyToManyField(Account, related_name='a_vote_down', blank=True)
    ...
    a_edited_by = models.ForeignKey(Account, on_delete=models.CASCADE, blank=True, null=True, related_name='a_edited_time')
...
class CommentQ(models.Model):
    ...
    date = models.DateTimeField(auto_now_add=True)
    com_upvote = models.ManyToManyField(Account, related_name='comm_upvote', blank=True)
...
class Bounty(models.Model):
    by_user = models.ForeignKey(Account, on_delete=models.CASCADE)
    question_bounty = models.ForeignKey(Question, on_delete=models.CASCADE)
    bounty_awarded_to = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='bounty_awarded_to', null=True, blank=True)
...
class ProtectQuestion(models.Model):
    protected_by = models.ForeignKey(Account, on_delete=models.CASCADE)
    protectionRemovedBy = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='protectionRemovedBy')
...
class Reputation(models.Model):
    awarded_to = models.ForeignKey(Account, on_delete=models.CASCADE, null=True,blank=True, related_name='reputation_awarded_to')
...
class BannedUser(models.Model):
    ...
    banned_by = models.ForeignKey(Account, on_delete=models.CASCADE, related_name="banned_by")
