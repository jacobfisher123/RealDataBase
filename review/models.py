...
class FirstAnswerReview(models.Model):
    AnswerReviewedBy = models.ForeignKey(Account, on_delete=models.CASCADE)
...
class FirstQuestionReview(models.Model):
    QuestionReviewBy = models.ForeignKey(Account, on_delete=models.CASCADE)
...
class LateAnswerReview(models.Model):
    L_AnswerReviewdBy = models.ForeignKey(Account, on_delete=models.CASCADE)
...
class QuestionEditVotes(models.Model):
    edit_suggested_by = models.ForeignKey(Account, on_delete=models.CASCADE)
...
class ReviewQuestionEdit(models.Model):
    ...
    edit_reviewed_by = models.ManyToManyField(Account, related_name="edit_reviewed_by")
...
class ReviewCloseVotes(models.Model):
    ...
    reviewed_by = models.ManyToManyField(Account, related_name="reviewed_by")
    is_completed = models.BooleanField(default=False)
...
class ReviewQuestionReOpenVotes(models.Model):
    ...
    reopen_reviewed_by = models.ManyToManyField(Account, related_name='reopen_reviewed_by')
    is_completed = models.BooleanField(default=False)
...
class LowQualityPostsCheck(models.Model):
    suggested_by = models.ForeignKey(Account, on_delete=models.CASCADE, null=True, blank=True)
...
class ReviewLowQualityPosts(models.Model):
    reviewers = models.ManyToManyField(Account, related_name="reviewers")
...
class FlagPost(models.Model):
    flagged_by = models.ForeignKey(Account, on_delete=models.CASCADE)
...
class ReviewFlagPost(models.Model):
    ...
    flag_reviewed_by = models.ForeignKey(Account, on_delete=models.CASCADE, blank=True, null=True)
...
class FlagComment(models.Model):
    ...
    comment_flagged_by = models.ForeignKey(Account, on_delete=models.CASCADE)
...
class ReviewFlagComment(models.Model):
    ...
    c_flag_reviewed_by = models.ForeignKey(Account, on_delete=models.CASCADE, null=True)
