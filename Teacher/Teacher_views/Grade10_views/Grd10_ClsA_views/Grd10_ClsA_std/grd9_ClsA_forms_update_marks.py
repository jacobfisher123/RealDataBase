...
from Student.student_views.Grade9_std_views.Grade9_models import Grade_9_student_classA
...
#split it up
class Grade_9_student_ClsA_updatemarks_english(ModelForm):
    class Meta:
        model=Grade_9_student_classA
        fields=['English_name1', 'English_score1', 'English_name2', 'English_score2', 'English_name3', 'English_score3',]


class Grade_9_student_ClsA_updatemarks_math(ModelForm):
    class Meta:
        model=Grade_9_student_classA
        fields=['Math_name1', 'Math_score1', 'Math_name2', 'Math_score2', 'Math_name3', 'Math_score3']

class Grade_9_student_ClsA_updatemarks_science(ModelForm):
    class Meta:
        model=Grade_9_student_classA
        fields=['Science_name1', 'Science_score1', 'Science_name2', 'Science_score2', 'Science_name3', 'Science_score3']
class Grade_9_student_ClsA_updatemarks_SocialScience(ModelForm):
    class Meta:
        model=Grade_9_student_classA
        fields=['SocialScience_name1', 'SocialScience_score1', 'SocialScience_name2', 'SocialScience_score2', 'SocialScience_name3', 'SocialScience_score3']
class Grade_9_student_ClsA_updatemarks_PersonalDevelopment(ModelForm):
    class Meta:
        model=Grade_9_student_classA
        fields=['PersonalDevelopment_name1', 'PersonalDevelopment_score1', 'PersonalDevelopment_name2', 'PersonalDevelopment_score2', 'PersonalDevelopment_name3', 'PersonalDevelopment_score3']
